        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden border border-[#C2C1C1]">
            <div className="bg-[#15445A] p-2 md:p-4">
              <h2 className="text-3xl font-bold text-center text-white">نموذج اعتماد برنامج</h2>
            </div>
            ...
            <div className="border-t border-[#C2C1C1]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 border-t border-[#C2C1C1]">
                ...
                <div className="p-2 md:p-4">
                  ...
                  <input
                    ...
                    className={`w-full px-2 md:px-4 py-2 border rounded-md focus:outline-none focus:ring-2 text-[#15445A] ${
                      errors.projectName
                        ? 'border-red-500 shadow-md shadow-red-300'
                        : 'border-[#C2C1C1] focus:ring-[#0DA9A6]'
                    }`}
                    placeholder={formData.projectName?.placeholder || ' أدخل اسم البرنامج'}
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 border-t border-[#C2C1C1]">
                ...
                {/* <div className="p-2 md:p-4">
                  ...
                  />
                  {errors.previousReading && <p className="text-red-500 text-sm mt-1">{errors.previousReading}</p>}
                </div> */}
                ...
                <div className="p-2 md:p-4">
                  ...
                  />
                  {errors.targetReading && <p className="text-red-500 text-sm mt-1">{errors.targetReading}</p>}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden border border-[#C2C1C1]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 border-t border-[#C2C1C1]">
              ...
              <div className="p-2 md:p-4 border-b md:border-b-0 md:border-l border-[#C2C1C1]">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-2 md:px-4 py-2 border rounded-md focus:outline-none focus:ring-2 text-[#15445A] ${
                    errors.email ? 'border-red-500 shadow-md shadow-red-300' : 'border-[#C2C1C1] focus:ring-[#0DA9A6]'
                  }`}
              ...
              <div className="p-2 md:p-4 border-b md:border-b-0 md:border-l border-[#C2C1C1]">
                ...
                <PhoneInput
                  ...
                  inputClass={`!w-full !px-2 md:!px-4 !py-2 !border !rounded-md !focus:outline-none !focus:ring-2 !text-[#15445A] ${
                    errors.phone
                      ? '!border-red-500 !shadow-md !shadow-red-300'
                      : '!border-[#C2C1C1] !focus:ring-[#0DA9A6]'
                  }`}
              ...
              <div className="p-2 md:p-4">
                ...
                />
                {errors.networkPhone && <p className="text-red-500 text-sm mt-1">{errors.networkPhone}</p>}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 border-t border-[#C2C1C1]">
              <div className="bg-[#0DA9A6] p-2 md:p-4 text-white font-semibold text-center border-l border-[#C2C1C1]">
                {formData.mainProjectObjective?.label || 'الهدف الرئيسي للبرنامج'}
              </div>
              <div className="p-2 md:p-4">
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 border-t border-[#C2C1C1]">
              <div className="bg-[#0DA9A6] p-2 md:p-4 text-white font-semibold text-center border-l border-[#C2C1C1]">
                {formData.detailedProjectDescription?.label || 'الوصف التفصيلي للبرنامج'}
              ...
              <div className="p-2 md:p-4">
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows="3"
                  className={`w-full px-2 md:px-4 py-2 border rounded-md focus:outline-none focus:ring-2 text-[#15445A] resize-none ${
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 border-t border-[#C2C1C1]">
              ...
              <div className="p-2 md:p-4 border-l border-[#C2C1C1]">
                ...
                />
                {errors.supportingAgency && <p className="text-red-500 text-sm mt-1">{errors.supportingAgency}</p>}
              </div>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden border border-[#C2C1C1]">
            <div className="bg-[#15445A] p-2 md:p-4">
              <h2 className="text-2xl font-bold text-center text-white">فريق العمل بالبرنامج</h2>
            </div>
                  ...
                  <div key={index} className="p-2 space-y-2">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-2 py-2 border rounded-md focus:outline-none focus:ring-2 text-[#15445A] ${
                ...
                <table className="min-w-full">
                  <thead>
                    <tr className="bg-[#0DA9A6] text-white">
                      ...
                      <th className="px-2 md:px-4 py-3 text-center font-semibold border-l border-[#C2C1C1]">
                        جهة العمل
                      </th>
                  ...
                  <tbody className="bg-white">
                    {formData.teamMembers.map((member, index) => (
                      <tr key={index} className="border-b border-[#C2C1C1]">
                        <td className="px-2 md:px-4 py-3 text-center border-l border-[#C2C1C1] font-medium">
                          {index + 1}
                        </td>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden border border-[#C2C1C1]">
            <div className="bg-[#15445A] p-2 md:p-4">
              <h2 className="text-2xl font-bold text-center text-white">مؤشرات الأداء الخاصة بالبرنامج</h2>
            </div>
            ...
            <div className="border-t border-[#C2C1C1]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 border-b border-[#C2C1C1]">
                ...
                <div className="p-2 md:p-4">
                  ...
                  />
                  {errors.firstIndicator && <p className="text-red-500 text-sm mt-1">{errors.firstIndicator}</p>}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 border-b border-[#C2C1C1]">
                ...
                <div className="p-2 md:p-4">
                  ...
                  />
                  {errors.secondIndicator && <p className="text-red-500 text-sm mt-1">{errors.secondIndicator}</p>}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="p-2 md:p-4">
                  ...
                  />
                  {errors.thirdIndicator && <p className="text-red-500 text-sm mt-1">{errors.thirdIndicator}</p>}
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="border-t border-[#C2C1C1]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 border-b border-[#C2C1C1]">
                ...
                <div className="p-2 md:p-4">
                  ...
                  />
                  {errors.uniqueProcedures && <p className="text-red-500 text-sm mt-1">{errors.uniqueProcedures}</p>}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="p-2 md:p-4">
                  ...
                  />
                  {errors.projectBudget && <p className="text-red-500 text-sm mt-1">{errors.projectBudget}</p>}
                </div>
              </div>
            </div>
          </div> */}
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden border border-[#C2C1C1]">
            <div className="bg-[#15445A] p-2 md:p-4">
              <h2 className="text-2xl font-bold text-center text-white">مدير الإدارة / عميد الكلية</h2>
            </div>
            ...
            <div className="md:hidden divide-y divide-[#C2C1C1]">
              <div className="p-2 space-y-2">
                ...
                <div>
                  ...
                  />
                  {errors.authoritySignature && (
                    <p className="text-red-500 text-sm mt-1">{errors.authoritySignature}</p>
                  )}
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="text-center">
              <button
                type="submit"
                disabled={loading}
                className={`px-8 py-3 bg-gradient-to-r from-[#0DA9A6] to-[#0C8B8A] text-white rounded-lg font-bold text-lg hover:from-[#0C8B8A] hover:to-[#0B7C7B] transition-all shadow-lg transform hover:scale-105 ${
