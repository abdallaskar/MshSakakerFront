  ...
  return (
    <nav
      ...
      <div className="flex items-center space-x-reverse">
        <button
          className="mr-4 p-2 rounded-xl  bg-white cursor-pointer"
          onClick={() => navigate('/')}
          aria-label="الصفحة الرئيسية">
          {/* <FiHome size={32} /> */}
          <img
            src="https://sr.edu.sa/site/wp-content/themes/sru-wp/img/logo.png"
            alt="Logo"
            className=" h-15 border-white cursor-pointer shadow-sm"
          />
        </button>
      </div>
      ...
      {user && (
        <div className="relative flex items-center space-x-reverse">
          ...
          {dropdownOpen && (
            <div
              className="absolute top-full left-0 mt-3 w-52 bg-white text-[#15445A] shadow-lg rounded-lg z-50 border border-gray-200 text-right"
              style={{ fontFamily: "'Helvetica Neue', 'Sakkal Majalla'" }}>
