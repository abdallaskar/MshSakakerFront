...
const FormPDF = ({ form }) => (
  <Document>
    ...
    <Page size="A4" style={styles.page}>
      <Text style={styles.header}>نموذج اعتماد برنامج</Text>
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.tableContainer} wrap={false}>
        <View style={styles.header}>
          <Text>فريق العمل بالبرنامج</Text>
        </View>
        <View style={styles.tableRow}>
      ...
      <View style={styles.tableContainer} wrap={false}>
        <View style={[styles.header, { marginTop: 2 }]}>
          <Text>مؤشرات الأداء الخاصة بالبرنامج</Text>
        </View>
        <View style={styles.tableRow}>
          <View style={[styles.headerCell, { width: '33.33%' }]}>
      ...
      <View style={styles.tableContainer} wrap={false}>
        {/* Authority approval */}
        <View style={[styles.header, { marginTop: 2 }]}>
          <Text>مدير الإدارة / عميد الكلية</Text>
        </View>
